        ...
        <div className="min-h-screen bg-gray-50 pb-10">
            <nav className="bg-white shadow-sm py-4 sticky top-0 z-40">
                ...
                <div className="flex gap-3">
                    <Link
                        to="/login"
                        className="px-4 py-1 bg-emerald-500 border border-blue-300 rounded-full hover:bg-gray-100 transition"
                    >
                        Đăng nhập
                    </Link>
                    ...
                    <Link
                        to="/register"
                        className="px-4 py-1 bg-amber-500 border border-blue-300 rounded-full hover:bg-gray-100 transition"
                    >
                        Đăng kí
                    </Link>
                </div>
